                                        ...
                                        <select id="barang_id" name="barang_id" class="form-control" required>
                                            ...
                                            @foreach ($data as $item)
                                                <option value="{{ $item->id }}">
                                                    {{ $item->nama_barang }} - {{ $item->merek }} - Rp
                                                    {{ number_format($item->harga, 0, ',', '.') }} (Stok:
                                                    {{ $item->stok }})
                                                </option>
                                            @endforeach
                                        </select>
                                            ...
                                            @if (session('cart') && count(session('cart')) > 0)
                                                ...
                                                @foreach (session('cart') as $id => $item)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="{{ route('kasir.update-cart-qty') }}"
                                                        ...
                                                        <td>
                                                            <form action="{{ route('kasir.remove-from-cart') }}"
                                                                method="POST">
                                                                @csrf
                                                                <input type="hidden" name="id"
                                                                    value="{{ $id }}">
                            ...
                            <form action="{{ route('kasir.checkout') }}" method="POST" id="checkoutForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" id="tunai_checkout" name="tunai"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="kembalian"
                                            value="{{ session('kembalian') ? number_format(session('kembalian'), 0, ',', '.') : '0' }}"
                                            readonly>
                                    </div>
                                </div>
